            ...
            <div class="row"><!--technical content-->
                <section>
                    <div class="container">
                        ...
                        <?php $id=1;
                        echo
                             '<a class="btn btn-default"  href="viewEvent copy.php?id='.$id.'"> <span class="glyphicon glyphicon-circle-arrow-right"></span>View Technical Events</a>'
                        ?>
                             </div><!--subcontent div-->
                    </div><!--container div-->
                </section>
                ...
                <section>
                    <div class="container">
                        ...
                        <div class="subcontent col-md-6"><!--Text holder with 6 column grid-->
                            ...
                            $id=2;
                            echo
                             '<a class="btn btn-default" href="viewEvent copy.php?id='.$id .'"> <span class="glyphicon glyphicon-circle-arrow-right"></span>View Gaming Events</a>'
                        ?>
                        </div><!--subcontent div-->
                    </div><!--container div-->
                </section>
                ...
                <section>
                    <div class="container">
                        ...
                        <div class="subcontent col-md-6"><!--Text holder with 6 column grid-->
                            ...
                            $id=3;
                            echo
                             '<a class="btn btn-default" href="viewEvent copy.php?id='.$id .'"> <span class="glyphicon glyphicon-circle-arrow-right"></span>View On-Stage Events</a>'
                        ?>
                        </div><!--subcontent div-->
                    </div><!--container div-->
                </section>
                ...
                <section>
                    <div class="container">
                        ...
                        <div class="subcontent col-md-6"><!--Text holder with 6 column grid-->
                            ...
                            $id=4;
                            echo
                             '<a class="btn btn-default" href="viewEvent copy.php?id='.$id .'"> <span class="glyphicon glyphicon-circle-arrow-right"></span>View Off-Stage Events</a>'
                        ?>
                        </div><!--subcontent div-->
                    </div><!--container div-->
                </section>
