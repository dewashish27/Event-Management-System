    ...
    <nav class="navbar" >
        ...
        <div class="navbar-header"><!--website name/title-->
            ...
            <ul class="nav navbar-nav navbar-right"><!--navigation-->
                    ...
                    <li class="btnlogout"><a class = "btn btn-default navbar-btn" href = "login.php">Login <span class = "glyphicon glyphicon-log-in"></span></a></li>
    ...
    <div class = "col-md-12">
        <div class = "container">
            <div class = "jumbotron"><!--jumbotron-->
                <h1><strong>Explore<br></strong> Your Desired Event</h1><!--jumbotron heading-->
